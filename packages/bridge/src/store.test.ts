...
import type { FocusPayload, SemanticSnapshot, ActivityEvent } from '@eyeglass/types';
...
function createMockSnapshot(overrides: Partial<SemanticSnapshot> = {}): SemanticSnapshot {
  return {
    role: 'button',
    name: 'Test Button',
    tagName: 'button',
...
function createMockPayload(overrides: Partial<FocusPayload> = {}): FocusPayload {
  return {
