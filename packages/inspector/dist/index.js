...
`;function p(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}function j(e,t){switch(e){case"idle":return"Ready";case"pending":return"Waiting for agent...";case"fixing":return w[t%w.length];case"success":return"Done!";case"failed":return"Failed";default:return e}}function pe(e,t,n,i){if(e&&(!t||n)){let s=i;return s||(s=document.createElement("style"),s.id="eyeglass-cursor-style",document.head.appendChild(s)),s.textContent=`
          ...
          ${t.history.map(d=>`
            <div class="hub-item" data-id="${d.interactionId}">
              ...
              <div class="hub-item-content">
                <div class="hub-item-component">${p(d.componentName)}</div>
                <div class="hub-item-note">${p(d.userNote)}</div>
              </div>
              ${d.status==="success"?`
  ...
  `;let a=e.querySelector(".hub-header"),l=e.querySelector(".hub-disable"),c=e.querySelector(".hub-settings-btn");a.addEventListener("click",d=>{d.target===l||d.target===c||d.target.closest(".hub-settings-btn")||n.onToggleExpanded()}),c.addEventListener("click",d=>{d.stopPropagation(),n.onOpenSettings()}),l.addEventListener("click",d=>{d.stopPropagation(),n.onToggleEnabled()}),e.querySelectorAll(".hub-item-undo").forEach(d=>{d.addEventListener("click",g=>{g.stopPropagation();let h=g.currentTarget.dataset.id;n.onUndo(h)})})}function ye(e,t,n){e.className="hub",e.innerHTML=`
    <div class="hub-header">
      <div class="hub-header-left">
        <div class="hub-logo">${ve}</div>
  ...
  `,e.querySelector(".hub-back-btn").addEventListener("click",()=>{n.onBack()}),e.querySelectorAll(".theme-btn").forEach(o=>{o.addEventListener("click",s=>{let r=s.currentTarget.dataset.theme;n.onThemeChange(r)})}),e.querySelectorAll(".toggle-switch").forEach(o=>{o.addEventListener("click",s=>{s.currentTarget.dataset.setting==="autoCommit"&&n.onAutoCommitToggle()})})}function Se(e,t){let n=e.map(i=>{switch(i.type){case"status":return i.status==="pending"||i.status==="fixing"&&(!i.message||i.message==="Agent is working...")?"":_t(i);case"thought":return Yt(i);case"action":return Ut(i);case"question":return Kt(i,e);default:return""}}).filter(Boolean);return n.length===0&&(t==="pending"||t==="fixing")?`
    ...
    <div class="activity-item">
      ...
      <div class="activity-content">
        <div class="activity-text">${p(e.message||e.status)}</div>
      </div>
    </div>
  `}function Yt(e){return`
    <div class="activity-item">
      ...
      <div class="activity-content">
        <div class="activity-text muted">${p(e.content)}</div>
      </div>
    </div>
  `}function Ut(e){let t={reading:"\u{1F4D6}",writing:"\u270F\uFE0F",searching:"\u{1F50D}",thinking:"\u{1F9E0}"},n={reading:"Reading",writing:"Writing",searching:"Searching",thinking:"Thinking about"};return`
    <div class="activity-item">
      ...
      <div class="activity-content">
        ...
        <div class="activity-target">${p(e.target)}</div>
      </div>
    </div>
  `}function Kt(e,t){return e.selectedAnswerId?`
      <div class="activity-item">
        ...
        <div class="activity-content">
          <div class="activity-text muted">${p(e.question)}</div>
          <div class="activity-target">${p(e.selectedAnswerLabel||e.selectedAnswerId)}</div>
        </div>
      </div>
    `:`
    <div class="question-box">
      <div class="question-text">${p(e.question)}</div>
  ...
  `:"";e.innerHTML=`
    <div class="panel-header">
      <span class="component-tag">&lt;${p(t.componentName)} /&gt;</span>
      ${t.filePath?`<span class="file-path">${p(t.filePath)}</span>`:""}
  ...
  `}function Le(e,t){let{currentSnapshot:n,mode:i,multiSelectMode:o,selectedSnapshots:s}=e;if(o&&s.length>0)return Zt(e);if(!n)return'<div class="lens-empty">No element selected</div>';let r=Ie(n),a=Wt(n),l=T(n),c=I(l),d=K(n);return i==="activity"?Qt(e,r,a):`
    <div class="lens-bar">
  ...
  `}function Qt(e,t,n){let{currentStatus:i,currentStatusMessage:o,activityEvents:s}=e,r=[...s].reverse().find(d=>d.type==="thought"),a=[...s].reverse().find(d=>d.type==="action"),l=[...s].reverse().find(d=>d.type==="question"&&d.questionId&&!d.answered),c="Working...";if(r)c=r.content;else if(a){let d=a;c=`${d.action}: ${d.target}${d.complete?" \u2713":"..."}`}else o?c=o:i==="pending"?c="Waiting for agent...":i==="success"?c="Done":i==="failed"&&(c="Failed");return`
    <div class="lens-bar">
