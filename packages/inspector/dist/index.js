...
`;function v(e){let n=document.createElement("div");return n.textContent=e,n.innerHTML}function V(e,n){switch(e){case"idle":return"Ready";case"pending":return"Waiting for agent...";case"fixing":return L[n%L.length];case"success":return"Done!";case"failed":return"Failed";default:return e}}function fe(e,n,t,s){if(e&&(!n||t)){let o=s;return o||(o=document.createElement("style"),o.id="eyeglass-cursor-style",document.head.appendChild(o)),o.textContent=`
  ...
  `}function ln(e,n,t){let{currentStatus:s,currentStatusMessage:i,activityEvents:o,_userNote:r,autoCommitEnabled:a}=e,c=s==="success"&&!a,d=[...o].reverse().find(m=>m.type==="thought"),l=[...o].reverse().find(m=>m.type==="action"),p=dn(o,s),h=ze(e.domPaused),u="Working...";if(d)u=d.content;else if(l){let m=l;u=`${m.action}: ${m.target}${m.complete?" \u2713":"..."}`}else i?u=i:s==="pending"?u="Waiting for agent...":s==="success"?u="Done":s==="failed"&&(u="Failed");return`
    <div class="lens-bar">
...
`}function cn(e){let{selectedSnapshots:n,_userNote:t}=e,s=ze(e.domPaused);return`
    ...
    <div class="lens-selection">
      ${n.map((i,o)=>`
        <div class="lens-chip">
          ...
          <span class="chip-name">&lt;${f(Re(i))} /&gt;</span>
  ...
  `}function Fe(e,n){let t=window.innerWidth,s=window.innerHeight,i=8,o=e.right+i;o+n.width>t-i&&(o=e.left-i-n.width),o<i&&(o=i);let r=e.top;return r+n.height>s-i&&(r=s-n.height-i),r<i&&(r=i),{x:Math.round(o),y:Math.round(r)}}function f(e){let n=document.createElement("div");return n.textContent=e,n.innerHTML}var qe=`
.lens-card {
  position: fixed;
  width: 220px;
  background: var(--glass-bg);
