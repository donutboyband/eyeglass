var Ct=new Set([0,1,11,14,15]);function Tt(t){let e=Object.keys(t).find(i=>i.startsWith("__reactFiber$")||i.startsWith("__reactInternalInstance$"));return e?t[e]:null}function B(t){if(!Ct.has(t.tag)||typeof t.type!="function")return!1;let n=t.type.displayName||t.type.name||"";return!(!n||n.startsWith("Context")||n.endsWith("Provider")||n==="StrictMode")}function j(t){return t.type.displayName||t.type.name||void 0}function Pt(t){let n=t;for(;n;){if(B(n))return n;n=n.return}return null}function O(t){let n=[],e=t;for(;e;){if(B(e)){let i=j(e);i&&n.push(i)}e=e.return}return n}function U(t){if(!t)return;let n={};for(let[e,i]of Object.entries(t)){if(e==="children")continue;let s=typeof i;(s==="string"||s==="number"||s==="boolean"||i===null)&&(n[e]=i)}return Object.keys(n).length>0?n:void 0}function Dt(t){let n=t.__vue__;if(n)return{name:"vue",componentName:n.$options?.name||n.$options?._componentTag};let i=Object.keys(t).find(s=>s.startsWith("__vue"));if(i){let s=t[i];if(s){let o=s,r,a;o?.type?.name?r=o.type.name:o?.type?.__name?r=o.type.__name:o?.component?.type?.name?r=o.component.type.name:o?.component?.type?.__name&&(r=o.component.type.__name);let l=o?.props||o?.component?.props;l&&(a=U(l));let u;return o?.type?.__file?u=o.type.__file:o?.component?.type?.__file&&(u=o.component.type.__file),{name:"vue",componentName:r,filePath:u,props:a}}return{name:"vue"}}return null}function Lt(t){let e=Object.keys(t).find(i=>i.startsWith("__svelte"));if(e){let i=t[e],s;if(i?.constructor?.name&&i.constructor.name!=="Object"&&(s=i.constructor.name),!s&&i?.$$?.ctx){let o=i.$$.ctx;o?.constructor?.name&&o.constructor.name!=="Object"&&(s=o.constructor.name)}return{name:"svelte",componentName:s}}return null}function T(t){let n=Tt(t);if(n){let s=Pt(n);if(s){let r=j(s),a=s._debugSource,l=O(s);return{name:"react",componentName:r,filePath:a?.fileName,lineNumber:a?.lineNumber,props:U(s.memoizedProps),ancestry:l.length>0?l:void 0}}let o=O(n);return{name:"react",ancestry:o.length>0?o:void 0}}let e=Dt(t);if(e)return e;let i=Lt(t);return i||{name:"vanilla"}}function Nt(t){let n=t.getAttribute("aria-label"),e=t.getAttribute("aria-describedby"),i=t.getAttribute("aria-disabled"),s=t.getAttribute("aria-expanded"),o=t.getAttribute("aria-checked"),r=t.getAttribute("aria-hidden"),a=null;e&&(a=document.getElementById(e)?.textContent?.trim()||null);let l=i==="true"||t.disabled||t.hasAttribute("disabled");return{label:n||t.getAttribute("title")||null,description:a,disabled:l,expanded:s?s==="true":void 0,checked:o==="true"?!0:o==="false"?!1:o==="mixed"?"mixed":void 0,hidden:r==="true"||t.hidden||!1}}function At(t){let n=t.getBoundingClientRect();return{x:Math.round(n.x),y:Math.round(n.y),width:Math.round(n.width),height:Math.round(n.height),visible:n.width>0&&n.height>0}}function $t(t){let n=getComputedStyle(t);return{display:n.display,position:n.position,flexDirection:n.flexDirection!=="row"?n.flexDirection:void 0,gridTemplate:n.display==="grid"?`${n.gridTemplateColumns} / ${n.gridTemplateRows}`:void 0,padding:n.padding,margin:n.margin,color:n.color,backgroundColor:n.backgroundColor,fontFamily:n.fontFamily,zIndex:n.zIndex}}function zt(t){let n=t.getAttribute("role");if(n)return n;let e=t.tagName.toLowerCase();return{a:"link",button:"button",input:t.type||"textbox",select:"combobox",textarea:"textbox",img:"img",nav:"navigation",main:"main",header:"banner",footer:"contentinfo",aside:"complementary",article:"article",section:"region",form:"form",ul:"list",ol:"list",li:"listitem",table:"table",tr:"row",td:"cell",th:"columnheader",dialog:"dialog",h1:"heading",h2:"heading",h3:"heading",h4:"heading",h5:"heading",h6:"heading"}[e]||"generic"}function Rt(t){let n=t.getAttribute("aria-label");if(n)return n;let e=t.getAttribute("aria-labelledby");if(e){let s=document.getElementById(e);if(s)return s.textContent?.trim()||""}if(t.tagName==="INPUT"||t.tagName==="SELECT"||t.tagName==="TEXTAREA"){let s=t.getAttribute("id");if(s){let o=document.querySelector(`label[for="${s}"]`);if(o)return o.textContent?.trim()||""}}if(t.tagName==="IMG")return t.alt||"";let i=t.textContent?.trim()||"";return i.length>50?i.slice(0,50)+"...":i}function qt(t){let n={},e=t.getAttribute("id");e&&(n.id=e);let i=t.getAttribute("class");i?.trim()&&(n.className=i.trim());let s={};for(let o=0;o<t.attributes.length;o++){let r=t.attributes[o];r.name.startsWith("data-")&&(s[r.name]=r.value)}return Object.keys(s).length>0&&(n.dataAttributes=s),n}function Ft(t){let n=getComputedStyle(t),e={display:n.display,position:n.position};return n.display.includes("flex")&&(n.flexDirection!=="row"&&(e.flexDirection=n.flexDirection),n.alignItems!=="normal"&&(e.alignItems=n.alignItems),n.justifyContent!=="normal"&&(e.justifyContent=n.justifyContent),n.gap!=="normal"&&n.gap!=="0px"&&(e.gap=n.gap)),n.display.includes("grid")&&(e.gridTemplate=`${n.gridTemplateColumns} / ${n.gridTemplateRows}`),e}function _t(t){let n=[],e=[],i=t.parentElement,s=0;for(;i&&s<2&&i!==document.body&&i!==document.documentElement;){let r=i.getAttribute("class")?.trim();n.push({tagName:i.tagName.toLowerCase(),...r&&{className:r},styles:Ft(i)}),i=i.parentElement,s++}let o=new Map;for(let r of Array.from(t.children)){let a=r.tagName.toLowerCase(),l=r.getAttribute("class")?.trim(),u=`${a}:${l||""}`;o.has(u)?o.get(u).count++:o.set(u,{className:l||void 0,count:1})}for(let[r,a]of o){let l=r.split(":")[0];e.push({tagName:l,...a.className&&{className:a.className},...a.count>1&&{count:a.count}})}return{parents:n,children:e}}function S(t){let n=qt(t);return{role:zt(t),name:Rt(t),tagName:t.tagName.toLowerCase(),...n,framework:T(t),a11y:Nt(t),geometry:At(t),styles:$t(t),neighborhood:_t(t),timestamp:Date.now(),url:window.location.href}}var f="http://localhost:3300",w="eyeglass_session",P="eyeglass_history",D="eyeglass_enabled",L="eyeglass_autocommit",N="eyeglass_theme";var v=["Ruminating...","Percolating...","Divining...","Grokking...","Communing...","Concocting...","Synthesizing...","Distilling...","Incubating...","Forging...","Scrutinizing...","Triangulating...","Unraveling...","Traversing...","Sifting...","Marshaling...","Hydrating...","Harmonizing...","Indexing...","Entangling..."],K='url("data:image/svg+xml;base64,") 8 8, crosshair';var Y=`
:host {
  all: initial;
  position: fixed;
  top: 0;
...
`;function d(t){let n=document.createElement("div");return n.textContent=t,n.innerHTML}function A(t,n){switch(t){case"idle":return"Ready";case"pending":return"Waiting for agent...";case"fixing":return v[n%v.length];case"success":return"Done!";case"failed":return"Failed";default:return t}}function G(t,n,e,i){if(t&&(!n||e)){let o=i;return o||(o=document.createElement("style"),o.id="eyeglass-cursor-style",document.head.appendChild(o)),o.textContent=`
...
</svg>`,Ot='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>',Bt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>',jt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>',Ut='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>',Kt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>',Yt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>';function Q(t,n,e){let i=n.hubExpanded?"":"collapsed",s=n.inspectorEnabled?"":"disabled",o=n.hubExpanded?"expanded":"",r=n.history.filter(c=>c.status==="pending"||c.status==="fixing").length;t.className=`hub ${i} ${s}`.trim(),t.innerHTML=`
        ...
        <div class="hub-settings-list">
          <div class="hub-setting-row">
            ...
            <div class="theme-selector">
              <button class="theme-btn ${n.themePreference==="light"?"active":""}" data-theme="light" title="Light">${Ut}</button>
  ...
  `,t.querySelector(".hub-back-btn").addEventListener("click",()=>{e.onBack()}),t.querySelectorAll(".theme-btn").forEach(s=>{s.addEventListener("click",o=>{let r=o.currentTarget.dataset.theme;e.onThemeChange(r)})}),t.querySelectorAll(".toggle-switch").forEach(s=>{s.addEventListener("click",o=>{o.currentTarget.dataset.setting==="autoCommit"&&e.onAutoCommitToggle()})})}function et(t,n){let e=t.map(i=>{switch(i.type){case"status":return i.status==="pending"||i.status==="fixing"&&(!i.message||i.message==="Agent is working...")?"":Gt(i);case"thought":return Wt(i);case"action":return Jt(i);case"question":return Vt(i,t);default:return""}}).filter(Boolean);return e.length===0&&(n==="pending"||n==="fixing")?`
  ...
  `}function Jt(t){let n={reading:"\u{1F4D6}",writing:"\u270F\uFE0F",searching:"\u{1F50D}",thinking:"\u{1F9E0}"},e={reading:"Reading",writing:"Writing",searching:"Searching",thinking:"Thinking about"};return`
    <div class="activity-item">
  ...
  `}function Vt(t,n){return t.selectedAnswerId?`
      <div class="activity-item">
        <div class="activity-icon question">?</div>
        <div class="activity-content">
          <div class="activity-text muted">${d(t.question)}</div>
          <div class="activity-target">${d(t.selectedAnswerLabel||t.selectedAnswerId)}</div>
        </div>
      </div>
    `:`
  ...
  `}function nt(t,n,e){if(e)return e;let i=window.innerHeight-t.bottom,s=n==="activity"?400:200,o=t.bottom+12;i<s&&t.top>s&&(o=t.top-s-12);let r=20,a=window.innerHeight-s-20;o=Math.max(r,Math.min(o,a));let l=t.left;return l+340>window.innerWidth-20&&(l=window.innerWidth-360),l<20&&(l=20),{x:l,y:o}}function it(t,n,e){let i=n.multiSelectMode,s=i?"multi-select-icon active":"multi-select-icon",o=i?`
  ...
  `;let a=t.querySelector(".input-field"),l=t.querySelector(".close-btn"),u=t.querySelector(".btn-secondary"),c=t.querySelector(".btn-primary"),m=t.querySelector(".multi-select-icon");l.addEventListener("click",()=>e.onClose()),u.addEventListener("click",()=>e.onClose()),c.addEventListener("click",()=>e.onSubmit(a.value)),a.addEventListener("keydown",h=>{h.key==="Enter"&&!h.shiftKey&&a.value.trim()&&(h.preventDefault(),e.onSubmit(a.value))}),m.addEventListener("click",()=>{e.onToggleMultiSelect()}),t.querySelectorAll(".selected-chip-remove").forEach(h=>{h.addEventListener("click",p=>{p.stopPropagation();let b=parseInt(p.currentTarget.dataset.index,10);e.onRemoveFromSelection(b)})}),t.querySelector(".panel-header").addEventListener("mousedown",e.onPanelDragStart),requestAnimationFrame(()=>a.focus())}function ot(t,n,e){let i=n.currentStatus==="success"||n.currentStatus==="failed",s=n.currentStatus==="success"&&!n.autoCommitEnabled,o=n.currentStatus==="success",r=n.submittedSnapshots.length,a=r>1?`${r} elements`:`&lt;${d(n.componentName)} /&gt;`,l=A(n.currentStatus,n.phraseIndex);t.innerHTML=`
    <div class="panel-header">
