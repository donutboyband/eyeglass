...
`;function g(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}function j(e,t){switch(e){case"idle":return"Ready";case"pending":return"Waiting for agent...";case"fixing":return w[t%w.length];case"success":return"Done!";case"failed":return"Failed";default:return e}}function pe(e,t,n,i){if(e&&(!t||n)){let s=i;return s||(s=document.createElement("style"),s.id="eyeglass-cursor-style",document.head.appendChild(s)),s.textContent=`
  ...
  `;let a=e.querySelector(".hub-header"),l=e.querySelector(".hub-disable"),d=e.querySelector(".hub-settings-btn");a.addEventListener("click",c=>{c.target===l||c.target===d||c.target.closest(".hub-settings-btn")||n.onToggleExpanded()}),d.addEventListener("click",c=>{c.stopPropagation(),n.onOpenSettings()}),l.addEventListener("click",c=>{c.stopPropagation(),n.onToggleEnabled()}),e.querySelectorAll(".hub-item-undo").forEach(c=>{c.addEventListener("click",h=>{h.stopPropagation();let p=h.currentTarget.dataset.id;n.onUndo(p)})})}function ye(e,t,n){e.className="hub",e.innerHTML=`
    <div class="hub-header">
      <div class="hub-header-left">
        <div class="hub-logo">${ve}</div>
  ...
  `,e.querySelector(".hub-back-btn").addEventListener("click",()=>{n.onBack()}),e.querySelectorAll(".theme-btn").forEach(o=>{o.addEventListener("click",s=>{let r=s.currentTarget.dataset.theme;n.onThemeChange(r)})}),e.querySelectorAll(".toggle-switch").forEach(o=>{o.addEventListener("click",s=>{s.currentTarget.dataset.setting==="autoCommit"&&n.onAutoCommitToggle()})})}function Se(e,t){let n=e.map(i=>{switch(i.type){case"status":return i.status==="pending"||i.status==="fixing"&&(!i.message||i.message==="Agent is working...")?"":_t(i);case"thought":return Yt(i);case"action":return Ut(i);case"question":return Kt(i,e);default:return""}}).filter(Boolean);return n.length===0&&(t==="pending"||t==="fixing")?`
  ...
  `}function we(e,t,n){if(n)return n;let i=window.innerHeight-e.bottom,o=t==="activity"?400:200,s=e.bottom+12;i<o&&e.top>o&&(s=e.top-o-12);let r=20,a=window.innerHeight-o-20;s=Math.max(r,Math.min(s,a));let l=e.left;return l+340>window.innerWidth-20&&(l=window.innerWidth-360),l<20&&(l=20),{x:l,y:s}}function Ee(e,t,n){let i=t.multiSelectMode,o=i?"multi-select-icon active":"multi-select-icon",s=i?`
    <div class="selected-list">
      ...
      <div class="selected-chips">
        ${t.selectedSnapshots.map((u,m)=>{let v=u.framework.componentName||u.tagName;return`
  ...
  `}function Le(e,t){let{currentSnapshot:n,mode:i,multiSelectMode:o,selectedSnapshots:s}=e;if(o&&s.length>0)return Zt(e);if(!n)return'<div class="lens-empty">No element selected</div>';let r=Ie(n),a=Wt(n),l=T(n),d=I(l),c=K(n);return i==="activity"?Qt(e,r,a):`
    <div class="lens-bar">
  ...
  `}function Qt(e,t,n){let{currentStatus:i,currentStatusMessage:o,activityEvents:s,_userNote:r}=e,a=[...s].reverse().find(h=>h.type==="thought"),l=[...s].reverse().find(h=>h.type==="action"),d=[...s].reverse().find(h=>h.type==="question"&&h.questionId&&!h.answered),c="Working...";if(a)c=a.content;else if(l){let h=l;c=`${h.action}: ${h.target}${h.complete?" \u2713":"..."}`}else o?c=o:i==="pending"?c="Waiting for agent...":i==="success"?c="Done":i==="failed"&&(c="Failed");return`
    <div class="lens-bar">
    ...
    <div class="lens-selection">
      ${t.map((i,o)=>`
        <div class="lens-chip">
          ...
          <span class="chip-name">&lt;${f(Ie(i))} /&gt;</span>
