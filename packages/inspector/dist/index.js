...
`;function g(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}function j(e,t){switch(e){case"idle":return"Ready";case"pending":return"Waiting for agent...";case"fixing":return k[t%k.length];case"success":return"Done!";case"failed":return"Failed";default:return e}}function pe(e,t,n,i){if(e&&(!t||n)){let s=i;return s||(s=document.createElement("style"),s.id="eyeglass-cursor-style",document.head.appendChild(s)),s.textContent=`
          ...
          ${t.history.map(c=>`
            <div class="hub-item" data-id="${c.interactionId}">
              ...
              <div class="hub-item-content">
                <div class="hub-item-component">${g(c.componentName)}</div>
                <div class="hub-item-note">${g(c.userNote)}</div>
              </div>
              ${c.status==="success"?`
  ...
  `;let a=e.querySelector(".hub-header"),l=e.querySelector(".hub-disable"),d=e.querySelector(".hub-settings-btn");a.addEventListener("click",c=>{c.target===l||c.target===d||c.target.closest(".hub-settings-btn")||n.onToggleExpanded()}),d.addEventListener("click",c=>{c.stopPropagation(),n.onOpenSettings()}),l.addEventListener("click",c=>{c.stopPropagation(),n.onToggleEnabled()}),e.querySelectorAll(".hub-item-undo").forEach(c=>{c.addEventListener("click",p=>{p.stopPropagation();let f=p.currentTarget.dataset.id;n.onUndo(f)})})}function ye(e,t,n){e.className="hub",e.innerHTML=`
    <div class="hub-header">
      <div class="hub-header-left">
        <div class="hub-logo">${ve}</div>
    ...
    <div class="lens-issues">
      ${e.map(t=>`
        <div class="lens-issue ${t.level}">
          ...
          <span class="issue-text">${m(t.message)}</span>
          <button class="issue-add-btn" data-action="issue-insert" data-issue="${m(t.message)}" title="Add to prompt">\u21B5</button>
        </div>
      `).join("")}
    </div>
  ...
  `}function Qt(e,t,n){let{currentStatus:i,currentStatusMessage:o,activityEvents:s,_userNote:r}=e,a=[...s].reverse().find(p=>p.type==="thought"),l=[...s].reverse().find(p=>p.type==="action"),d=en(s,i),c="Working...";if(a)c=a.content;else if(l){let p=l;c=`${p.action}: ${p.target}${p.complete?" \u2713":"..."}`}else o?c=o:i==="pending"?c="Waiting for agent...":i==="success"?c="Done":i==="failed"&&(c="Failed");return`
    <div class="lens-bar">
      <span class="lens-tag">&lt;${m(t)} /&gt;</span>
      <span class="lens-status-badge ${i}">${i}</span>
      <div class="lens-tools">
        <button class="lens-tool lens-close" data-action="close" title="Close"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
      </div>
    </div>
    ${n?`<div class="lens-path">${m(n)}</div>`:""}
    <div class="lens-activity">
      ${i==="fixing"?'<div class="lens-progress"><div class="lens-progress-bar"></div></div>':""}
      <div class="lens-message">${m(c)}</div>
      ${r?`<div class="lens-user-note" title="Original request">${m(r)}</div>`:""}
      ${d}
      ${i==="success"||i==="failed"?`
    ...
    <div class="lens-selection">
      ${t.map((i,o)=>`
        <div class="lens-chip">
          ...
          <span class="chip-name">&lt;${m(Le(i))} /&gt;</span>
  ...
  `}function en(e,t){if(e.length===0)return"";let n=e.map(i=>tn(i)).filter(i=>!!i).join("");return n?`<div class="lens-feed">${n}</div>`:t==="pending"||t==="fixing"?`
      ...
      `:""}function tn(e){switch(e.type){case"status":return nn(e);case"thought":return`
        <div class="lens-feed-item">
          ...
          <div class="lens-feed-body lens-feed-subtle">${m(e.content)}</div>
        </div>
      `;case"action":return`
        <div class="lens-feed-item">
          <div class="lens-feed-dot action"></div>
          <div class="lens-feed-body">
            <div class="lens-feed-title">${m(e.action)}${e.complete?" \u2713":" ..."}</div>
            <div class="lens-feed-subtle">${m(e.target)}</div>
          </div>
        </div>
    ...
    <div class="lens-feed-item">
      ...
      <div class="lens-feed-body">${m(e.message||e.status)}</div>
    </div>
  `}function sn(e){let t=!!e.selectedAnswerId,n=e.selectedAnswerLabel||e.options.find(i=>i.id===e.selectedAnswerId)?.label||"";return t?`
      <div class="lens-feed-item question answered">
        ...
        <div class="lens-feed-body">
          <div class="lens-feed-question">${m(e.question)}</div>
          <div class="lens-feed-answer">${m(n)}</div>
        </div>
      </div>
    `:`
        ...
        <div class="lens-feed-options">
          ${e.options.map(i=>`
            <button
              ...
              data-question-id="${e.questionId}"
              data-answer-id="${i.id}"
              data-answer-label="${m(i.label)}"
            >${m(i.label)}</button>
          `).join("")}
        </div>
      </div>
    </div>
  `}function Pe(e,t){let n=window.innerWidth,i=window.innerHeight,o=8,s=e.right+o;s+t.width>n-o&&(s=e.left-o-t.width),s<o&&(s=o);let r=e.top;return r+t.height>i-o&&(r=i-t.height-o),r<o&&(r=o),{x:Math.round(s),y:Math.round(r)}}function m(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}var $e=`
.lens-card {
  position: fixed;
  width: 220px;
  background: var(--glass-bg);
