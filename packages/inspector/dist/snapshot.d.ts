 ...
 */
import type { SemanticSnapshot, InteractionStateInfo } from '@eyeglass/types';
/**
 * Capture a complete semantic snapshot of an element
 * Returns all 7 layers of frontend reality
 */
export declare function captureSnapshot(element: Element, interactionState?: InteractionStateInfo): SemanticSnapshot;
